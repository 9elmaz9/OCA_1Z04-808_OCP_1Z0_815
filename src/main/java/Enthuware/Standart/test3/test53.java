 ...
 *  ( i.e. primitives as well as Objects). Remember that:
 ...
 *  Anexample: Object o1 = new Object();  Let us say, this object is stored at memory location 15000.
 *  Since o1 actually stores just the address of the memory location where the object is stored, it contains 15000.
 ...
 *  someMethod( Object localVar) {  localVar now contains 15000,
 *  which means localVar also points to the same memory location where the object is stored.
 ...
 *  then localVar starts pointing to a different memory location. But the original variable o1 still
