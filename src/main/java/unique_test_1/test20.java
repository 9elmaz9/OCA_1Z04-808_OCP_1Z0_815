 ...
 *  A Double can also be passed to a method that takes Object, but Number is more specific than Object
 *  therefore probe(Number ) will be called.  We advise you to run this program and try out various combinations.
 *  The exam has questions on this pattern.*/
