...
/**Which of the following can be used as a constructor
 * for the class given below?  public class TestClass{
...
/**You can use only one of public protected and private.
 ...
 need for a constructor to be synchronized, because it would lock the object under construction,
 which is normally not made available to other threads until all constructors for the object have
 completed their work. The lack of native constructors is an arbitrary language design choice that
 makes it easy for an implementation of the Java Virtual Machine to verify that superclass constructors
