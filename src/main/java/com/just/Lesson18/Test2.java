    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < array2.length; i++) {  // у нас length 3
            ...
            for (int j = 0; j < array2[i].length; j++) {
                ...
                int[] array9 = {1, 2, 3,}; // в фигурных скобка сразу запишем какие элементы будут содержаться в этом массиве , тут нигде мы не отмечаем длину массива, java сама считает
            }
